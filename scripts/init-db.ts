...
async function initializeDatabase() {
  try {
    ...
    `)
    console.log('[Database Init] ✓ restaurants table created')
    ...
    `)
    console.log('[Database Init] ✓ menu_categories table created')
    ...
    `)
    console.log('[Database Init] ✓ menu_items table created')
    ...
    `)
    console.log('[Database Init] ✓ menu_items_translations table created')
    ...
    console.log('[Database Init] ✓ All indexes created')
